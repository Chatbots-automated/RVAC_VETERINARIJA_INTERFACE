-- REVERT MIGRATION: Restore vw_treated_animals_detailed to calculate withdrawal dates
-- This reverts the changes made in 20260213000000_fix_treated_animals_view_use_stored_withdrawal.sql
--
-- USE THIS ONLY IF: The fix causes issues and you need to go back to the old behavior
--
-- This restores the view to recalculate withdrawal dates from reg_date + product withdrawal days
-- Manual ŽURNALAS edits will NOT be reflected in the report after running this
...
SELECT 
    ...
    -- Column 12: Išlauka (Withdrawal period) - REVERTED TO CALCULATED
