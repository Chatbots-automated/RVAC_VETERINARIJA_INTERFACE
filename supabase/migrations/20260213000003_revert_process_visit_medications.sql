/*
  # Revert process_visit_medications to original version
  
  This reverts the changes made in 20260213000002_fix_process_visit_medications_copy_disease.sql
  Restores the original function that doesn't copy disease information.
*/
