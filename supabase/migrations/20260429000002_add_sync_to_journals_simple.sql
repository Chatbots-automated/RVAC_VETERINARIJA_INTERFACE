-- =====================================================================
-- Simple: Add Synchronization Medicines to Journals
-- =====================================================================
-- Adds sync medicines from usage_items where purpose='synchronization'
-- These have no treatment_id, so we need a separate branch
-- =====================================================================
...
COMMENT ON VIEW public.vw_treated_animals_detailed IS 'Treated animals with medications from treatments, courses, and synchronization protocols';
