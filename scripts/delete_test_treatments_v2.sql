-- =====================================================================
-- Delete Test Treatments and Return Stock (Working Version)
-- =====================================================================
-- Based on actual schema and working frontend code
-- =====================================================================
...
-- STEP 3: Return stock and delete (RUN THIS TO ACTUALLY DELETE)
DO $$
DECLARE
    v_treatment_id UUID;
...
BEGIN
    -- Loop through each treatment to delete
    ...
    LOOP
        ...
        -- Return stock from treatment_courses (only if batch_id is not null)
        UPDATE batches b
        SET 
        ...
        RAISE NOTICE 'Deleted treatment % and returned stock', v_treatment_id;
    END LOOP;
    
    RAISE NOTICE 'Total: Deleted % treatments and returned stock', v_deleted_count;
END $$;
